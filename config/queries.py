...
DROP_QUERIES = "\n".join(
    list(reversed(["DROP TABLE IF EXISTS {table_name};".format(table_name=table_name) for table_name in TABLES_SCHEMA.keys()])))
CREATE_QUERIES = """
        ...
        CREATE TABLE IF NOT EXISTS comp_entrepreneurs (
            ...
            ent_website VARCHAR(255) NULL,
            ent_contact_details json NULL,
            ent_extension_details json NULL,
